...
BEGIN
    ...
    FROM APPSUPPORT.TSP###_#_final_person_list
    ;
...
BEGIN
    ...
    (
	select distinct PERSON_ID_LIST
	from appsupport.TSP###_#_merge_log
    )
    LOOP
...
BEGIN
	...
	and (pm.person_id IS NULL or me.id IS NOT NULL)
	and m.table_oid IN
	(
	    SELECT DISTINCT 
		d.table_oid
    ...
    ORDER BY has_me DESC, table_oid, id
    ;
